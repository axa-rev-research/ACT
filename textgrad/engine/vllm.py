    ...
    def __init__(
        ...
        **llm_config,
        ...
        extra = dict(
            ...
            max_model_len=int(os.getenv("VLLM_MAX_LEN", "32696")),
            enforce_eager=True,
        )

        # Attention backend: honor env if set, else pick a stable default
        attn_env = os.getenv("VLLM_ATTENTION_BACKEND")
        extra.setdefault("attention_backend", (attn_env.lower() if attn_env else "xformers"))
